...
integer, parameter :: testInt = 31, xn =50, yn = 50, altnum = 85, mstep = 10000, cell = 2
integer, parameter :: tn = 1000000, g_pri = 5, g_sec = 28, g_sol = 15, g_med = 7
real(8) :: x_min = 0.0D+00, x_max = 3000.0D+00, y_min = -1300.0D+00, y_max = 0.0D+00
real(8) :: t_min = 0.0D+00, t_max = 200000000000.0 
